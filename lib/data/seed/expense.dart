...
final List<Expense> seedExpenses = [
  ...
  Expense(DateTime(2024, 4, 20), 1200.0, 'Electricity bill', 'Utilities', 'KPLC', 'Bank Transfer', 'receipt_002.jpg'),
  Expense(DateTime(2024, 4, 15), 300.0, 'Stationery', 'Office Supplies', 'Office Depot', 'Cash', 'receipt_003.jpg'),
  Expense(DateTime(2024, 4, 10), 800.0, 'Plastic bags', 'Packaging', 'Packaging Solutions Ltd', 'Credit Card', 'receipt_004.jpg'),
